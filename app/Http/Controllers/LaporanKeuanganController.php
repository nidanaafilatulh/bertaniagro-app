            ...
            ->where(function ($q) {
                $q->where(function ($sub) {
                    $sub->whereIn('t.pelanggan', ['Aeon Mall', 'Istana Buah'])
                        ->whereRaw('LOWER(p.satuan) != "pack" AND LOWER(p.nama_produk) = "selada"');
                })
